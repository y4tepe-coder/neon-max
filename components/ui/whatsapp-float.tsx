...
export function WhatsAppFloat() {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-6 left-6 z-40 flex items-center gap-3 flex-row-reverse"
    >
      {/* Tooltip */}
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="bg-white rounded-xl px-4 py-2.5 shadow-lg border border-gray-100 pointer-events-none"
          >
            <p className="text-text-dark font-semibold text-sm whitespace-nowrap">
              WhatsApp schreiben
            </p>
            <p className="text-text-muted text-xs whitespace-nowrap">Schnelle Antwort</p>
          </motion.div>
        )}
      </AnimatePresence>
